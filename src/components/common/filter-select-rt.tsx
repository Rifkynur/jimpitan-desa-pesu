...
const FilterSelectRt = ({ selectedRt, setSelectedRt, isChart = false }: FilterSelectRtProps) => {
  ...
  return <SelectComponent loading={isLoading} onChange={setSelectedRt} options={data ?? []} value={selectedRt} placeholder="Pilih Rt" />;
};
